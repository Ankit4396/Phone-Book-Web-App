...
<div class="row">
  <ul class="breadcrumb">
      <li><a href="index.php"><img src="download1.jfif" style="height:20px"></a></li>
      <li class="active"><?php echo ($_GET["m"] == "update") ? "Edit" : "Click to  back"; ?> to home</li>
    </ul>
</div>
      ...
      <div class="panel-body">
        ...
        <form class="form-horizontal" name="contact_form" id="contact_form" enctype="multipart/form-data" method="post" action="process_form.php">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-lg-4 control-label" for="contact_no2">Alternative No :</label>
              <div class="col-lg-5">
            ...
            <div class="form-group">
              <div class="col-lg-5 col-lg-offset-4">
                <button class="btn btn-primary" type="submit to create contact">Submit</button> 
              </div>
            </div>
          </fieldset>
        </form>
